import { FloatNullableFilterInput as GraphQLFloatNullableFilterInput } from '@refetched/graphql-types';
import { getPrismaFromGraphQLFloatNullableFilterInput } from '..';

describe('GIVEN the function', () => {
  let input: GraphQLFloatNullableFilterInput;
  ...
  describe('AND the equals field', () => {
    describe('EQUALS null', () => {
      ...
      test('THEN it should get the Prisma', () => {
        const received = getPrismaFromGraphQLFloatNullableFilterInput(input);
